...
public class ProductEntity {
    ...
    @SequenceGenerator(
            schema = "supplies", name = "supplies.product_id_seq",
            sequenceName = "supplies.product_id_seq", allocationSize = 1
    )
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "supplies.product_id_seq")
